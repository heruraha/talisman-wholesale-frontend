...
const ParallaxHeader = (props) => {
    ...
    return (
    <div className="carousel slide my-3" data-ride="carousel">
        <ol className="carousel-indicators">
            {props.img.map((e, i) => 
                <li 
                    className={slide === i ? 'active' : null} 
                    onClick={() => setSlide(i)} key={i} 
                    style={{backgroundColor: props.color ? props.color : '#6637D0'}} />
            )}
        </ol>
        ...
        <a className="carousel-control-prev justify-content-start" onClick={back}>
            <span className="prev-icon" style={{backgroundColor: props.color ? props.color : '#6637d0'}}>
        ...
        <a className="carousel-control-next justify-content-end" onClick={forward}>
            <span className="next-icon" style={{backgroundColor: props.color ? props.color : '#6637d0'}}>
                <svg width="14" height="25" viewBox="0 0 14 25">
